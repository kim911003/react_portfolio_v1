let resumeData = {
    ...
    "aboutme":"저는 사범대학교 컴퓨터교육과를 졸업하고, 취미로 즐기던 프로그래밍을 전문적으로 다루기 시작했습니다. 국비 지원을 통해 처음 프로그래밍을 배우고, 개인 프로젝트를 진행하면서 실무 능력을 끌어올린 뒤 기업에서 진행하는 여러 프로젝트에 참여를 할 수 있었습니다. 처음부터 잘하진 못하였지만, 누구보다도 스스로가 부족한 점이 무엇인지 알기에 빠르게 캐치하여 팀원들과 협업할 수 있는 개발자가 되었습니다. 신기술에 대한 거부감이 없고, 회사에서 원하는 기술을 빠르게 터득하여 활용할 수 있는 인재입니다. 현재는 기업에서 진행하는 프로젝트 개발 및 유지 보수해 나가고 있으며, 개인적인 시간에는 React.js와 Node.js에 대한 기술을 알아가고 있습니다.",
    "address":"경기도 구리시 수택동",
